...
const App = () => {
  const users = [
    ...
    {
      img:'https://images.unsplash.com/photo-1521898284481-a5ec348cb555?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fHdvcmtpbmd8ZW58MHx8MHx8fDA%3D',
      intro:'', 
      tag:'Underbanked'
    }
  ]
